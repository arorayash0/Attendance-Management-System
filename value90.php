		...
		th{
			...
			background-color: #ff8080;
				...
				error_reporting(0);
				  ...
				  $selectQuery = "SELECT * FROM student WHERE Semester = 2";
			...
			<input type="submit" style="padding: 5px 10; border-radius: 5px; margin-top:5px; background: #000; color: fff;"; value="submit" name="save">
